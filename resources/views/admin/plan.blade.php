                ...
                <div class="row">
                    <div class="col-12 col-lg-4 col-md-6">
                        <div class="card p-4 rounded" style="height:285px; background-color:rgb(14, 13, 13); color:white;">
                            ...
                            <button class="btn custom text-white rounded-2"
                                style="margin-top: 65px; border: 1px solid #737988">Active Plan</button>
                        </div>
                    </div>
                    <div class="col-12 col-lg-4 col-md-6">
                        <div class="card p-4 rounded">
                            ...
                            <form action="" method="post" id="change-price-form">
                                ...
                                <input name="price" class="p-1 my-3 rounded-2" type="number"
                                    placeholder="Change price here" id="pro-price-1" data-plan-id="1" required>
                                <button type="submit" class="btn mb-3 custom change-price-button rounded-2">Change
                                    Price</button>
                            </form>
                        </div>
                    </div>
