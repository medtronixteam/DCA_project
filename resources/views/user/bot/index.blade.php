            ...
            <div class="col-12 col-lg-8 col-md-6">
                <div class="card"style="background-color: #263544; color: #ffffff;">
                    <div class="card-body">
                            ...
                            <div class="card custom-card mt-2" style="background-color: #263544; color: #ffffff; border: 1px solid #737988;"style="background-color: #263544; color: #ffffff;">
                                <div class="card-body">
                                    ...
                                    <form>
                                        <div class="mb-3">
                                            ...
                                            <input  type="text" class="form-control bg-dark border-0 rounded-2 p-2 text-white" id="name" placeholder="Name">
                                        </div>

                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <label for="exchange" class="form-label">Exchange</label>
                                                <select id="exchange" class="form-select  bg-dark border-0 rounded-2 p-2 text-white">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select id="bot-type" class="form-select  bg-dark border-0 rounded-2 p-2 text-white">
                                                    <option selected>Select...</option>
